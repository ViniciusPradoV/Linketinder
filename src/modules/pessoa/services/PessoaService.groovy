...
class PessoaService {
     ...
     static List<PessoaJuridica> getEmpresas(){
        ...
        List<PessoaJuridica> listaEmpresas = [
                new PessoaJuridica(1,1,"FromSoftware", "fkaokdfo@email.com", "SP", "11111-111", "Fazemos software", "1111111111", VagaService.getVagas()),
                new PessoaJuridica(2,2,"BSoftware", "fkaokdfo@email.com", "GO", "11111-111", "Fazemos software", "1111111111",VagaService.getVagas()),
                new PessoaJuridica(3,3,"CSoftware", "fkaokdfo@email.com", "SC", "11111-111", "Fazemos software", "1111111111",VagaService.getVagas()),
                new PessoaJuridica(4,4,"DSoftware", "fkaokdfo@email.com", "MG", "11111-111", "Fazemos software", "1111111111",VagaService.getVagas()),
                new PessoaJuridica(5,5,"FSoftware", "fkaokdfo@email.com", "PB", "11111-111", "Fazemos software", "1111111111",VagaService.getVagas()),
        ]
    ...
    static PessoaJuridica cadastrarEmpresa(List<PessoaJuridica> listaEmpresas) {
        ...
        int idade = Integer.parseInt(PrintAndGetService.printAndGet("Digite a idade da empresa:\n"))
        String nome = PrintAndGetService.printAndGet("Digite seu nome completo:\n")
        String email = PrintAndGetService.printAndGet("Digite seu email de contato:\n")
        String estado = PrintAndGetService.printAndGet("Digite estado de residencia:\n")
        String cep = PrintAndGetService.printAndGet("Digite o seu CEP atual:\n")
        ...
        return new PessoaJuridica(uid, idade, nome, email, estado, cep, descricao, cpf, VagaService.getVagas())
    }
